        ...
        <Wrapper className={errorLoading ? "error" : ""}>
            ...
            <Screen className={currentStep === 1 ? "active" : currentStep === 2 ? "active-2" : ""}>
                ...
                <WrapperConfirm className={currentStep === 2 ? "active" : ""}>
                    ...
                    <ConfirmTextCell>
                        <ConfirmTextExtended text={"Group Name"} value={formCreateGrouping.groupName} className={"confirm-text group-name"}/>
                    </ConfirmTextCell>
                    <ConfirmTextCell>
                        <ConfirmTextExtended text={"PDF - File Name"} value={formCreateGrouping.pdf.fileName} className={"confirm-text"}/>
                        <ConfirmTextExtended text={"PDF - File Path"} value={formCreateGrouping.pdf.filePath} className={"confirm-text"}/>
                    </ConfirmTextCell>
                    <ConfirmTextCell>
                        <ConfirmTextExtended text={"RESTFul - Email"} value={formCreateGrouping.pdf.fileName} className={"confirm-text email"}/>
                        <ConfirmTextExtended text={"RESTFul - Mail Title"} value={formCreateGrouping.pdf.fileName} className={"confirm-text"}/>
                        <ConfirmTextExtended text={"RESTFul - Mail Content"} value={formCreateGrouping.pdf.filePath} className={"confirm-text"}/>
                    </ConfirmTextCell>
                    <ConfirmTextCell>
                        <ConfirmTextExtended text={"Redirect - IP Address"} value={formCreateGrouping.redirect.ipAddress} className={"confirm-text"}/>
                        <ConfirmTextExtended text={"Redirect - Port"} value={formCreateGrouping.redirect.port} className={"confirm-text"}/>
                    </ConfirmTextCell>
                    <CheckBoxResultCell>
            ...
            <CloseBtn onClick={e => { e.preventDefault(); toggleCreateModal(); resetFormCreateGrouping(); }}>
